...
#  Dataset loaded is from the Child Anthropology study,
#
#  We examine the column datatypes and missing entries
#  and produce a plot 'q12.png' that displays Stature vs age for males and females
# ########################
require(ggplot2)
require(hrbrthemes)
library(ggplot2)
